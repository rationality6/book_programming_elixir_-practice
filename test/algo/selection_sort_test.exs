defmodule Algo.SelectionSortTest do
  ...
  test "셀렉션 소트 최종 sort 비교 1" do
    ...
    result = array0 |> Algo.SelectionSort.sort()
  ...
  test "smaller" do
    assert Algo.SelectionSort.smaller(1, 2) == 1
    assert Algo.SelectionSort.smaller(2, 1) == 1
    assert Algo.SelectionSort.smaller(2, 3) == 2
    assert Algo.SelectionSort.smaller(3, 3) == 3
  end
end
